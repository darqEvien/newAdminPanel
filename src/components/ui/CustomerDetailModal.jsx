...
const CustomerDetailModal = ({ isOpen, onClose, customer }) => {
    ...
    return Object.entries(customer.products).map(([orderKey, orderData]) => (
      ...
      >
        ...
        <div className="flex items-start justify-between mb-3">
          {/* Dimensions */}
          {customer.dimensions?.kontiWidth &&
          ...
          <div className="flex gap-2">
            {/* Edit Button */}
            <button
               onClick={() => handleEditOrder(orderKey, orderData)}
  ...
  return (
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[90vw] w-[90vw] h-[85vh] max-h-[85vh] p-6">
          ...
          <div className="flex-1 space-y-6 overflow-y-auto pr-4">
            ...
            <div className="bg-gray-800/30 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-gray-200">Siparişler</h2>
